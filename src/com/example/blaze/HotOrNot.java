...
public class HotOrNot {
	...
	public long createEntry(String ourName, String ourHotness) {
		// TODO Auto-generated method stub
		ContentValues cv = new ContentValues();
		cv.put(KEY_NAME, ourName);
		cv.put(KEY_HOTNESS, ourHotness);
		System.out.println("gt here");
		long newRow = ourDatabase.insert(DATABASE_TABLE, null, cv);
